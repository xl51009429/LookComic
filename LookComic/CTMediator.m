...
//获取控制器
- (UIViewController *)CTMediator_viewControllerWithTarger:(NSString *)target action:(NSString *)action params:(NSDictionary *)params
{
    UIViewController *viewController = [self performTarget:target
                                                    action:action
                                                    params:params];
